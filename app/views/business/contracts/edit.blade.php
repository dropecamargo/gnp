...
@section ('title') Editar contrato @stop
...
@section ('content')
    ...
    <div class="row">
        <div class="form-group col-md-3">
            ...
            {{ Form::text('cliente_cedula', $customer->cedula, array('placeholder' => 'Ingrese cliente', 'class' => 'form-control')) }}        
        	{{ Form::hidden('cliente', $customer->id, array('id' => 'cliente')) }}
        </div>
        <div class="form-group col-md-6">        	
            {{ Form::label('cliente_nombre', 'Nombre') }}
            {{ Form::text('cliente_nombre', $customer->nombre, array('class' => 'form-control', 'disabled' => 'disabled')) }}        
        </div>
        <div class="form-group col-md-3">
    ...
    <div class="row">
        <div class="form-group col-md-3">
            ...
            {{ Form::text('valor', null, array('placeholder' => 'Valor', 'class' => 'form-control', 'readonly' => 'readonly')) }}        
        </div> 
        <div class="form-group col-md-3">
            {{ Form::label('cuotas', 'Cuotas') }}
            {{ Form::text('cuotas', null, array('placeholder' => 'Número de cuotas', 'class' => 'form-control', 'readonly' => 'readonly')) }}        
        </div>
        <div class="form-group col-md-3">
            {{ Form::label('periodicidad', 'Periodicidad de pago') }}
            {{ Form::text('periodicidad', null, array('placeholder' => 'Periodicidad (días)', 'class' => 'form-control', 'readonly' => 'readonly')) }}        
        </div> 
        <div class="form-group col-md-3">
